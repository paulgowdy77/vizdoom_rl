...
for mode, mode_dict in LEVDOOM_LEVEL_DICTIONARY.items():
    for difficulty, level_dict in mode_dict.items():
        for level_name, level_config in level_dict.items():
            new_dict[level_name] = {
                "mode": mode,
                "difficulty": difficulty,
                "level_name": level_name,
                "level_wad_file": level_config
            }

print(json.dumps(new_dict, indent=4))   

with open("levdoom_level_dict.json", "w") as f:
